...
fun main(args: Array<String>) {
    ...
    System.setProperty("SECURITY-TOKEN-SERVICE-JWKS_URL", properties.getProperty("SECURITY-TOKEN-SERVICE-JWKS_URL"))
    System.setProperty("SECURITY-TOKEN-SERVICE-ISSUER_URL", properties.getProperty("SECURITY-TOKEN-SERVICE-ISSUER_URL"))
